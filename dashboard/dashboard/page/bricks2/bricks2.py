...
# =========================
@frappe.whitelist()
def get_delivery_notes(from_date=None, to_date=None, customer=None, brick_size=None):
...
# Returns ROW-LEVEL data (with date) so JS can apply date filters before aggregating
# =========================
@frappe.whitelist()
